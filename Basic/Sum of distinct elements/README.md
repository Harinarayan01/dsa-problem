<h2><a href="https://practice.geeksforgeeks.org/problems/sum-of-distinct-elements4801/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Sum of distinct elements</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an array <strong>Arr</strong> of size <strong>N</strong>. Find the sum of distinct elements in an array.</span></p>
